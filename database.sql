...
VALUES ('through_the_window.jpg', 'A bearded man taks a picture of another bearded man through a window', 'landscape'),
('ramen_boys.jpg', 'Three young men happily wait for ramen', 'portrait'),
('train_man.jpg', 'An aspiring train conductor tries his hand at operating a train on the Yamanote Line', 'portrait'),
...
('kfc.jpg', 'A man poses for a picture in front of a statue of Colonel Sanders dressed in a Hanshin Tiger''s uniform', 'portrait'),
('balloon_boy.jpg', 'A happy baseball fan holds up his Hanshin Tiger''s 7th inning balloon', 'portrait')
